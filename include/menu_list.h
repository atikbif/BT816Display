...
enum MENU_LIST {MENU_MAIN, MENU_APPL_INFO, MENU_CLUST_INFO, MENU_ALARM_LIST, MENU_PASSWD, MENU_CLR_ALARMS, MENU_HELP, MENU_PC21, MENU_MNEMO, MENU_MANAGE, MENU_DIAGN, MENU_DI,
