...
const uint8_t mnemo1_data[] = {
	...
	0x00,0x00,	// 0x3E
	0x00,0x00,	// 0x40
	MNEMO_ID_BACKGROUND_IMAGE>>8,MNEMO_ID_BACKGROUND_IMAGE&0xFF,1,0x00,0x00,0x20,0x00,	// 0x42
	...
	MNEMO_ID_LAMP>>8,MNEMO_ID_LAMP&0xFF,1,LAMP_RED,LAMP_GRAY,LAMP_YELLOW,VAR_LINK_DO>>8,VAR_LINK_DO&0xFF,0,0,0,125,0,200,	// 0xAB
	MNEMO_ID_LAMP>>8,MNEMO_ID_LAMP&0xFF,1,LAMP_RED,LAMP_GRAY,LAMP_YELLOW,VAR_LINK_DO>>8,VAR_LINK_DO&0xFF,0,1,0,225,0,200,	// 0xB9
	MNEMO_ID_LAMP>>8,MNEMO_ID_LAMP&0xFF,1,LAMP_RED,LAMP_GRAY,LAMP_YELLOW,VAR_LINK_DO>>8,VAR_LINK_DO&0xFF,0,2,325>>8,325&0xFF,0,200,	// 0xC7
	MNEMO_ID_LAMP>>8,MNEMO_ID_LAMP&0xFF,1,LAMP_RED,LAMP_GRAY,LAMP_YELLOW,VAR_LINK_DO>>8,VAR_LINK_DO&0xFF,0,3,425>>8,425&0xFF,0,200,	// 0xD5
	MNEMO_ID_LAMP>>8,MNEMO_ID_LAMP&0xFF,1,LAMP_RED,LAMP_GRAY,LAMP_YELLOW,VAR_LINK_DO>>8,VAR_LINK_DO&0xFF,0,4,525>>8,525&0xFF,0,200,	// 0xE3
	MNEMO_ID_LAMP>>8,MNEMO_ID_LAMP&0xFF,1,LAMP_RED,LAMP_GRAY,LAMP_YELLOW,VAR_LINK_DO>>8,VAR_LINK_DO&0xFF,0,5,625>>8,625&0xFF,0,200,	// 0xF1

	MNEMO_ID_TEXT>>8,MNEMO_ID_TEXT&0xFF,1,255,0,0,90>>8,90&0xFF,105>>8,105&0xFF,26,'D','I','1',0,	// 0xFF
	MNEMO_ID_TEXT>>8,MNEMO_ID_TEXT&0xFF,1,255,0,0,190>>8,190&0xFF,105>>8,105&0xFF,26,'D','I','2',0,	// 0x10E
	MNEMO_ID_TEXT>>8,MNEMO_ID_TEXT&0xFF,1,255,0,0,290>>8,290&0xFF,105>>8,105&0xFF,26,'D','I','3',0,	// 0x11D
	MNEMO_ID_TEXT>>8,MNEMO_ID_TEXT&0xFF,1,255,0,0,390>>8,390&0xFF,105>>8,105&0xFF,26,'D','I','4',0,	// 0x12C
	MNEMO_ID_TEXT>>8,MNEMO_ID_TEXT&0xFF,1,255,0,0,490>>8,490&0xFF,105>>8,105&0xFF,26,'D','I','5',0,	// 0x13B
	MNEMO_ID_TEXT>>8,MNEMO_ID_TEXT&0xFF,1,255,0,0,590>>8,590&0xFF,105>>8,105&0xFF,26,'D','I','6',0,	// 0x14A
	MNEMO_ID_TEXT>>8,MNEMO_ID_TEXT&0xFF,1,255,0,0,690>>8,690&0xFF,105>>8,105&0xFF,26,'D','I','7',0,	// 0x159

	MNEMO_ID_TEXT>>8,MNEMO_ID_TEXT&0xFF,1,255,0,0,140>>8,140&0xFF,255>>8,255&0xFF,26,'D','O','1',0,	// 0x168
	MNEMO_ID_TEXT>>8,MNEMO_ID_TEXT&0xFF,1,255,0,0,240>>8,240&0xFF,255>>8,255&0xFF,26,'D','O','2',0,	// 0x177
	MNEMO_ID_TEXT>>8,MNEMO_ID_TEXT&0xFF,1,255,0,0,340>>8,340&0xFF,255>>8,255&0xFF,26,'D','O','3',0,	// 0x186
	MNEMO_ID_TEXT>>8,MNEMO_ID_TEXT&0xFF,1,255,0,0,440>>8,440&0xFF,255>>8,255&0xFF,26,'D','O','4',0,	// 0x195
	MNEMO_ID_TEXT>>8,MNEMO_ID_TEXT&0xFF,1,255,0,0,540>>8,540&0xFF,255>>8,255&0xFF,26,'D','O','5',0,	// 0x1A4
	MNEMO_ID_TEXT>>8,MNEMO_ID_TEXT&0xFF,1,255,0,0,640>>8,640&0xFF,255>>8,255&0xFF,26,'D','O','6',0,	// 0x1B3
};

const uint8_t mnemo2_data[] = {
	0x15,0xA2,0x00,0x15,	// 0x00
	0x00,0x32,	// 0x04
	0x00,0x39,	// 0x06
	0x00,0x51,	// 0x08
	0x00,0x61,	// 0x0A
	...
	0x00,0x00,	// 0x2E
	0x00,0x00,	// 0x30
	MNEMO_ID_BACKGROUND_IMAGE>>8,MNEMO_ID_BACKGROUND_IMAGE&0xFF,1,0x00,0x01,0x10,0x00,	// 0x32
	MNEMO_ID_GAUGE>>8,MNEMO_ID_GAUGE&0xFF,1,0,100,0,100,0,50,5,3,1000>>8, 1000&0xFF,VAR_LINK_CL_REG>>8,VAR_LINK_CL_REG&0xFF,0,0,0,0,200,0,0,900>>8,900&0xFF,	// 0x39
	MNEMO_ID_TEXT_VAR>>8,MNEMO_ID_TEXT_VAR&0xFF,1,0,80,0,155,28,1,VAR_LINK_CL_REG>>8,VAR_LINK_CL_REG&0xFF,0,0,255,255,255,	// 0x51
	MNEMO_ID_GAUGE>>8,MNEMO_ID_GAUGE&0xFF,1,0,250,0,100,0,50,5,3,1000>>8, 1000&0xFF,VAR_LINK_CL_REG>>8,VAR_LINK_CL_REG&0xFF,0,1,0,0,200,0,0,800>>8,800&0xFF,	// 0x61
	MNEMO_ID_TEXT_VAR>>8,MNEMO_ID_TEXT_VAR&0xFF,1,0,230,0,155,28,1,VAR_LINK_CL_REG>>8,VAR_LINK_CL_REG&0xFF,0,1,255,255,255,	// 0x79
	MNEMO_ID_GAUGE>>8,MNEMO_ID_GAUGE&0xFF,1,400>>8,400&0xFF,0,100,0,50,5,3,1000>>8, 1000&0xFF,VAR_LINK_CL_REG>>8,VAR_LINK_CL_REG&0xFF,0,2,0,0,200,0,0,850>>8,850&0xFF,	// 0x89
	MNEMO_ID_TEXT_VAR>>8,MNEMO_ID_TEXT_VAR&0xFF,1,380>>8,380&0xFF,0,155,28,1,VAR_LINK_CL_REG>>8,VAR_LINK_CL_REG&0xFF,0,2,255,255,255,	// 0xA1
	MNEMO_ID_GAUGE>>8,MNEMO_ID_GAUGE&0xFF,1,550>>8,550&0xFF,0,100,0,50,5,3,1000>>8, 1000&0xFF,VAR_LINK_CL_REG>>8,VAR_LINK_CL_REG&0xFF,0,3,0,0,200,0,0,950>>8,950&0xFF,	// 0xB1
	MNEMO_ID_TEXT_VAR>>8,MNEMO_ID_TEXT_VAR&0xFF,1,530>>8,530&0xFF,0,155,28,1,VAR_LINK_CL_REG>>8,VAR_LINK_CL_REG&0xFF,0,3,255,255,255,	// 0xC9
	MNEMO_ID_GAUGE>>8,MNEMO_ID_GAUGE&0xFF,1,700>>8,700&0xFF,0,100,0,50,5,3,1000>>8, 1000&0xFF,VAR_LINK_CL_REG>>8,VAR_LINK_CL_REG&0xFF,0,4,0,0,200,0,0,700>>8,700&0xFF,	// 0xD9
	MNEMO_ID_TEXT_VAR>>8,MNEMO_ID_TEXT_VAR&0xFF,1,680>>8,680&0xFF,0,155,28,1,VAR_LINK_CL_REG>>8,VAR_LINK_CL_REG&0xFF,0,4,255,255,255,	// 0xF1
	MNEMO_ID_PROGR>>8,MNEMO_ID_PROGR&0xFF,1,0x50,0x50,0x50,0x00,0x00,0x00, 80>>8,80&0xFF,220>>8,220&0xFF,0,30,0,150,1000>>8,1000&0xFF,VAR_LINK_CL_REG>>8,VAR_LINK_CL_REG&0xFF,0,0, // 0x101
	MNEMO_ID_PROGR>>8,MNEMO_ID_PROGR&0xFF,1,0x50,0x50,0x50,0x00,0x00,0x00, 230>>8,230&0xFF,220>>8,220&0xFF,0,30,0,150,1000>>8,1000&0xFF,VAR_LINK_CL_REG>>8,VAR_LINK_CL_REG&0xFF,0,1, // 0x118
	MNEMO_ID_PROGR>>8,MNEMO_ID_PROGR&0xFF,1,0x50,0x50,0x50,0x00,0x00,0x00, 380>>8,380&0xFF,220>>8,220&0xFF,0,30,0,150,1000>>8,1000&0xFF,VAR_LINK_CL_REG>>8,VAR_LINK_CL_REG&0xFF,0,2, // 0x12F
	MNEMO_ID_PROGR>>8,MNEMO_ID_PROGR&0xFF,1,0x50,0x50,0x50,0x00,0x00,0x00, 530>>8,530&0xFF,220>>8,220&0xFF,0,30,0,150,1000>>8,1000&0xFF,VAR_LINK_CL_REG>>8,VAR_LINK_CL_REG&0xFF,0,3, // 0x146
	MNEMO_ID_PROGR>>8,MNEMO_ID_PROGR&0xFF,1,0x50,0x50,0x50,0x00,0x00,0x00, 680>>8,680&0xFF,220>>8,220&0xFF,0,30,0,150,1000>>8,1000&0xFF,VAR_LINK_CL_REG>>8,VAR_LINK_CL_REG&0xFF,0,4, // 0x15D
	MNEMO_ID_TEXT>>8,MNEMO_ID_TEXT&0xFF,1,200,200,200,85>>8,85&0xFF,15>>8,15&0xFF,30,'R','1',0,	// 0x174
	MNEMO_ID_TEXT>>8,MNEMO_ID_TEXT&0xFF,1,200,200,200,235>>8,235&0xFF,15>>8,15&0xFF,30,'R','2',0,	// 0x182
	MNEMO_ID_TEXT>>8,MNEMO_ID_TEXT&0xFF,1,200,200,200,385>>8,385&0xFF,15>>8,15&0xFF,30,'R','3',0,	// 0x190
	MNEMO_ID_TEXT>>8,MNEMO_ID_TEXT&0xFF,1,200,200,200,535>>8,535&0xFF,15>>8,15&0xFF,30,'R','4',0,	// 0x19E
	MNEMO_ID_TEXT>>8,MNEMO_ID_TEXT&0xFF,1,200,200,200,685>>8,685&0xFF,15>>8,15&0xFF,30,'R','5',0,	// 0x1AC
};
